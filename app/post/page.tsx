  ...
  return (
    <div className="flex flex-col p-5 items-center justify-center mt-32">
      <div className="bg-[#0a0a0a] p-5 border-[0.5px] border-gray-700 rounded-lg sm:w-1/3 w-full flex flex-col gap-5 text-gray-400">
        <h2 className="text-[#e9e9e9] text-xl font-bold flex items-center gap-2"><PencilIcon />Post a confession anonymously 🤫 </h2>
        ...
        <button className='text-white bg-red-500 px-3 py-1 rounded-sm ' disabled={loading} onClick={handleClick}>{!loading ? "Post" : <l-waveform size="35" stroke="3.5" speed="1" color="black"></l-waveform>}</button>
      </div>
    </div>
  )
}
